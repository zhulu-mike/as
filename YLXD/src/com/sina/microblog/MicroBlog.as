...
//			trace("========================================");
		 ...
		 * 
		 */		
		public function login(view:DisplayObject,userName:String=null, password:String=null):void
		{	
			_webView = new StageWebView;
			_webView.stage = view.stage;
			_webView.viewPort = new Rectangle(0,0,view.stage.stageWidth,view.stage.stageHeight);
