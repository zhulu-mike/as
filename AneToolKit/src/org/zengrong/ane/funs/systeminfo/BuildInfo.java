...
public class BuildInfo implements FREFunction
{
	...
	public FREObject call(FREContext $context, FREObject[] $arg)
	{
		...
		try
		{
			...
			TelephonyManager pm = (TelephonyManager) $context.getActivity().getSystemService(Context.TELEPHONY_SERVICE);
			__obj.setProperty("DEVICEID", FREObject.newObject(pm.getDeviceId()));
